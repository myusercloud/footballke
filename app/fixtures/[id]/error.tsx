    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-center rounded-sm border border-zinc-200 bg-white px-6 py-16 text-center shadow-sm">
        ...
        <p className="mt-2 max-w-xs text-sm leading-6 text-zinc-500">
          Something went wrong loading the match page. Please try again.
          {error.digest && (
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <Link
            href="/fixtures"
            className="rounded-sm border border-zinc-200 px-5 py-2.5 text-sm font-bold text-zinc-700 transition-colors hover:border-zinc-300 hover:bg-zinc-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
          >
            All fixtures
          </Link>
        </div>
